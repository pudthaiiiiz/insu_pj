...
class MainApiCtrl extends CI_Controller {
  ...
  public function callGetService(){
    ...
    $isData = $this->Model_package->getMain($this->input->post('inputYear'),$this->input->post('inputIdBrand'),$this->input->post('inputIdSeries'));
      if($isData != 0 ){
        $resp['status'] = 'success';
        $resp['data'] = $isData;
      }
