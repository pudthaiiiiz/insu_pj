...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<a href="#" class="logo">
				<img src="<?php echo base_url(); ?>assets/images/logo.png" width="250" alt="" />
			</a>
			
			<p class="description">Admin ! System Controller By <a href="#">Pichet Kunjai</a></p>
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="form-login-error">
				<h3>Invalid login</h3>
				<h3>รหัสผ่านไม่ถูกค้องการุณาลองใหม่อีกครั้ง</h3>
			</div>
			...
			<form method="post" role="form" id="form_login">
				...
				<div class="form-group">
					<button type="submit" name='submit' value='xxx' class="btn btn-primary btn-block btn-login">
