...
<div class="panel panel-primary" data-collapsed="0">
        ...
        <form method="POST" action="<?php echo base_url(); ?>api-edit-content" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
          ...
          <div class="form-group">
              ...
              <br />
              <img src="<?php echo base_url();?>../uploads/${cImage}" width="120px" />
						</div>
					</div>
					<div class="form-group">
