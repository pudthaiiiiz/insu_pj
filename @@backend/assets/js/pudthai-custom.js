...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
		...
		$('#wait').click(function(){
			$('.loading').html('<img src="assets/images/loader-1.gif" style="width: 150px;">');
		});
		...
		$("#rating-img").html('<img src="../assets/images/rating/rating_0.png" style="margin-top: 3px;">');
		$("#rating").change(function(){
			var rat = $("#rating").val();

			if(rat == 1){
				$("#rating-img").html('<img src="../assets/images/rating/rating_1.png" style="margin-top: 3px;">');
			}else if(rat == 2){
				$("#rating-img").html('<img src="../assets/images/rating/rating_2.png" style="margin-top: 3px;">');
			}else if(rat == 3){
				$("#rating-img").html('<img src="../assets/images/rating/rating_3.png" style="margin-top: 3px;">');
			}else if(rat == 4){
				$("#rating-img").html('<img src="../assets/images/rating/rating_4.png" style="margin-top: 3px;">');
			}else if(rat == 5){
				$("#rating-img").html('<img src="../assets/images/rating/rating_5.png" style="margin-top: 3px;">');
			}else{
				$("#rating-img").html('<img src="../assets/images/rating/rating_0.png" style="margin-top: 3px;">');
			}
