...
--
-- Host: localhost:3306
-- Generation Time: Jul 17, 2015 at 11:49 AM
...
CREATE TABLE `tbl_amphur_postcode` (
...
--
-- Indexes for table `tbl_amphur_postcode`
--
ALTER TABLE `tbl_amphur_postcode`
  ADD PRIMARY KEY (`AMPHUR_ID`,`POST_CODE`);
